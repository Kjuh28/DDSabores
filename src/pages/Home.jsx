...
export function Home(){
    return(
        <Container className=''>
            <div id="home" className="bg-amber_100 gap-x-4 pl-5 p-2 pr-5 flex flex-wrap 2xl:flex-nowrap xl:justify-between" >
                <div className="" >
                    <img src="../src/assets/avatar_ds.jpg" alt="Avatar_Confeiteira" className="rounded-xl sm:h-auto xl:max-w-xl" />
                </div>
                <div>
