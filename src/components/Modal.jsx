    ...
    const handleOpen = () => setOpen(!open);
        ...
        return(
           <>
                ...
                <div className="mx-auto w-screen sm:w-64 h-64 bg-amber_400 border rounded justify-center text-center items-center">
                    <DialogHeader className="justify-center font-bold"> {cardTitle} </DialogHeader>
                        <DialogBody className="justify-center items-center text-center">
                            ...
                            <button onClick={handleOpen} className="border rounded bg-amber_200 w-24 p-1">Quero este!</button>
                            <button onClick={handleOpen} className="border rounded bg-amber_200 w-24 p-1">Cancelar</button>
                        </DialogFooter>
                    </DialogBody>
                </div>
